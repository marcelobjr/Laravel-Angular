...
<head>
	...
	@if(Config::get('app.debug'))
        <link rel="stylesheet" href="{{ asset('build/css/app.css') }}" rel="stylesheet">
        <link rel="stylesheet" href="{{ asset('build/css/components.css') }}" rel="stylesheet">
        <link rel="stylesheet" href="{{ asset('build/css/flaticon.css') }}" rel="stylesheet">
        <link rel="stylesheet" href="{{ asset('build/css/font-awesome.css') }}" rel="stylesheet">
    @else
        <link rel="stylesheet" href="{{ elixir('css/all.css') }}" rel="stylesheet">
    @endif
